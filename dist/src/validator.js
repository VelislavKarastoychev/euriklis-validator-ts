...
const warnings = __importStar(require("./Warnings/index"));
...
class validator {
     ...
     */
    constructor(parameter = undefined) {
    ...
    set description(text) {
        if (new validator(text).isString.or.isNumber.answer) {
            ...
            errors.IncorrectDescriptionProperty();
    }
    /**
    ...
    describe(message) {
        if (new validator(message).isString.and.not.isEmpty.answer) {
            ...
            errors.IncorrectParameterInDescribe();
        return this;
    }
    /**
    ...
    get isPositive() {
        if (this.copy().not.isNumber.answer) {
            if (this.show_warnings)
                warnings.IncorrectValueInIsPositive();
            this.#question = false;
        }
        else {
    ...
    isArrayOfNumbersInRange(a, b) {
        const isInputIncorrect = new validator([a, b]).not.isNumberArray
            .or.bind(new validator(a).isGreaterThanOrEqual(b)).answer;
        if (isInputIncorrect)
            errors.IllegalParametersInIsArrayOfNumbersInRange();
        if (this.copy().isArray.or.isTypedArray.answer) {
    ...
    isArrayOfIntegersInRange(a, b) {
        ...
        if (this.copy().not.isArray.and.not.isTypedArray.answer) {
            ...
            this.#question = models.IsArrayOfIntegersInRange(this.value, a, b);
        return this.#set_answer();
    }
    /**
     * Checks if the "value" property of the current validator
    ...
    get isArrayOfObjectArrays() {
        if (this.copy().not.isArray.answer)
            this.#question = false;
        else
            this.#question = models.IsArrayOfObjectArrays(this.value);
        return this.#set_answer();
    }
    /**
     * Checks if the "value" property of the current validator
    ...
    get isArrayOfObjectArraysWithEqualSize() {
        if (this.copy().not.isArray.answer)
            ...
            this.#question = models.IsArrayOfObjectArraysWithEqualSize(this.value);
        return this.#set_answer();
    }
    ...
    isInstanceof(instance) {
        if (models.IsInstanceType(instance)) {
            ...
            errors.IncorrectArgumentInIsInstanceof();
        return this.#set_answer();
    }
    /**
     * Checks if the "value" property of the current validator
    ...
    hasLength(n) {
        if (Number.isInteger(n))
            ...
            errors.IncorrectArgumentInHasLength();
        ...
        if (cp_instance.isArray.or.isTypedArray.or.isString.answer) {
            ...
            this.#question = models.TestCondition(Object.keys(cp_instance.value), "length", n);
        }
    ...
    hasLengthGreaterThan(n) {
        if (Number.isInteger(n))
            ...
            errors.IncorrectArgumentInHasLengthBiggerThan();
        let cp_instance = this.copy();
        if (cp_instance.isArrayBuffer.answer) {
            ...
            this.#question = models.TestCondition(Object.keys(cp_instance.value), "length", n, "gt");
        }
    ...
    hasLengthEqualsOrGreaterThan(n) {
        if (Number.isInteger(n))
            ...
            errors.IncorrectArgumentInHasLengthEqualsOrBiggerThan();
        let cp_instance = this.copy();
        if (cp_instance.isArrayBuffer.answer) {
            ...
            this.#question = models.TestCondition(Object.keys(cp_instance.value), "length", n, "geq");
        }
        else if (cp_instance.isSet.or.isMap.answer) {
    ...
    hasLengthLessThan(n) {
        if (Number.isInteger(n))
            ...
            errors.IncorrectArgumentInHasLengthLesserThan();
        let cp_instance = this.copy();
        if (cp_instance.isArrayBuffer.answer) {
            ...
            this.#question = models.TestCondition(Object.keys(cp_instance.value), "length", n, "lt");
        }
        else if (cp_instance.isSet.or.isMap.answer) {
    ...
    hasLengthEqualsOrLessThan(n) {
        if (Number.isInteger(n))
            ...
            errors.IncorrectArgumentInHasLengthEqualsOrLesserThan();
        let cp_instance = this.copy();
        if (cp_instance.isArrayBuffer.answer) {
            ...
            this.#question = models.TestCondition(Object.keys(cp_instance.value), "length", n, "leq");
        }
        else if (cp_instance.isSet.or.isMap.answer) {
    ...
    hasLengthInRange(a, b) {
        if (Number.isInteger(a) && Number.isInteger(b)) {
            ...
            b = Number(b);
            if (a >= b)
                errors.IncorrectArgumentsInHasLengthInRange();
        }
        else
            errors.IncorrectArgumentsInHasLengthInRange();
        let cp_instance = this.copy();
    ...
    hasLengthInClosedRange(a, b) {
        if (Number.isInteger(a) && Number.isInteger(b)) {
            ...
            b = Number(b);
            if (a >= b)
                errors.IncorrectArgumentsInHasLengthInClosedRange();
        }
        else
            errors.IncorrectArgumentsInHasLengthInClosedRange();
        let cp_instance = this.copy();
    ...
    get isEmpty() {
        ...
        if (test.isUndefined.or.isNull.answer) {
            ...
            errors.IncorrectArgumentInIsEmpty();
        return this.#set_answer();
    }
    /**
    ...
    interface(params) {
        ...
        if (areValueAndParamsCorrect) {
            const isParamsCorrect = p.forEvery((parameter) => parameter.isFunction).answer;
            if (isParamsCorrect) {
    ...
    isSame(param) {
        ...
        if (t.isPrimitiveType.answer) {
            ...
            errors.InappropriateValueInIsSame();
        return this.#set_answer();
    }
    /**
